...
void make_picture(int **picture, int n, int m) {
    ...
    for (int i = 0; i < length_sun_data; i++) {
        picture[1][7 + i] = sun_data[0][i];
        picture[2][7 + i] = sun_data[1][i];
        picture[3][7 + i] = sun_data[2][i];
        picture[4][7 + i] = sun_data[3][i];
        picture[5][7 + i] = sun_data[4][i];
        picture[6][7 + i] = sun_data[5][i];
        picture[13][7 + i] = sun_data[5][i];
    }
